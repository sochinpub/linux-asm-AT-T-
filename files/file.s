...
#PURPOSE: This function actuall does
#         the conversion to upper case for a block
#
...
.que ST_BUFFER, 12    # actual buffer
...
convert_loop:
  # get the curreent type
    movb (%eax, %edi, 1), %cl
    # go the the next byte unless it is between 'a' and 'z'
    cmpb $LOWERCASE_A, %cl
    jl next_byte
    cmpb $LOWERCASE_Z, %cl
    jg next_byte
